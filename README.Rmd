...
# par(mfrow = c(3, 2), cex.main = 2, cex.lab = 1.5)
par(mfrow = c(2, 4), cex.main = 2, cex.lab = 1.5)
plot(fit$Beta_est[,1], coef(dds)[,1] / log2(exp(1)), 
     main = "Beta Coefficients", xlab = "glmGamPoi", ylab = "DESeq2")
abline(0,1)
plot(fit$Beta_est[,1], edgeR_fit$unshrunk.coefficients[,1],
     main = "Beta Coefficients", xlab = "glmGamPoi", ylab = "edgeR")
abline(0,1)

plot(fit$Mu_est[,1], rowData(dds)$baseMean, log="xy",
     main = "Gene Mean", xlab = "glmGamPoi", ylab = "DESeq2")
abline(0,1)
plot(fit$Mu_est[,1], edgeR_fit$fitted.values[,1], log="xy",
     main = "Gene Mean", xlab = "glmGamPoi", ylab = "edgeR")
abline(0,1)

plot(fit$overdispersions, rowData(dds)$dispGeneEst, log="xy",
     main = "Overdispersion", xlab = "glmGamPoi", ylab = "DESeq2")
abline(0,1)
plot(fit$overdispersions, edgeR_fit$dispersion, log="xy",
