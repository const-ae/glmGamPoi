...
```{r}
fit <- glm_gp(reduced_sce, design = ~ condition*cell + ind, verbose = TRUE)
res <- test_de(fit, contrast = fact(cell = "B cells", condition = "stim") - fact(cell = "B cells", condition = "ctrl"))
```
